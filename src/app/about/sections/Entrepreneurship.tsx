    ...
    <section id="entrepreneurship" aria-labelledby="entrepreneurship-heading" role="contentinfo">
      <article>
        <div className="flex flex-col sm:flex-row sm:space-x-8 mb-4">
          <div className="mr-4 flex-shrink-0 md:block hidden mx-auto">
            <Image
          ...
          <div className="flex-1 mb-4">
            <div className="flex justify-between items-top">
              <h3 className="mb-0">Allora Hospitality</h3>
              <p className="text-right text-md md:block hidden text-base-300">2016 - 2022</p>
            </div>
            <div className="flex justify-between items-top">
              <p className="text-md text-base-300 mb-2">Owner / Operator</p>
              <p className="text-right text-sm text-base-300 md:block hidden">Haddonfield, NJ</p>
            </div>
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-8 mb-4">
          ...
          <div className="flex-1 mb-4">
            <div className="flex justify-between items-top">
              <h3 className="mb-0">Gearadelphia</h3>
              <p className="text-right text-md md:block hidden text-base-300">2013 - 2018</p>
            </div>
            <div className="flex justify-between items-top">
              <p className="text-md mb-2 text-base-300">Owner / Operator</p>
              <p className="text-right text-sm text-base-300 md:block hidden">Philadelphia, PA</p>
            </div>
            <ul className="text-sm m-0 pl-3 text-secondary-content">
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-8 mb-4">
          ...
          <div className="flex-1 mb-4">
            <div className="flex justify-between items-top">
              <h3 className="mb-0">Flyers Faithful</h3>
              <p className="text-right text-md md:block hidden text-base-300">2008 - 2014</p>
            </div>
            <div className="flex justify-between items-top">
              <p className="text-md mb-2 text-base-300">Owner / Operator</p>
              <p className="text-right text-sm text-base-300 md:block hidden">Philadelphia, PA</p>
