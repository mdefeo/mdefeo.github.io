  ...
  return (
    <section id="chat" aria-labelledby="chat-heading" role="contentinfo">
      <div className="grid grid-cols-1 lg:grid-cols-2 mx-auto w-full md:gap-8">
        <article className="w-full lg:flex lg:flex-col lg:justify-center md:mb-10 mx-auto order-2 lg:order-1">
            <Image
              src="/images/moc.png"
              alt="Master of the Classics design made by my business, Gearadelphia."
              className="hidden md:block hover:shadow-none pb-0 mb-5 w-1/2 h-auto md:w-10/12 mx-auto text-center"
              width={1859}
              height={1183}
              priority
            />
            <div className="text-sm md:text-normal w-full mb-5 mt-5 md:mt-0">
          ...
          <aside className="w-full h-full flex justify-center items-center order-1 lg:order-2">
            <ChatContainer />
          </aside>
        </div>
    </section>
