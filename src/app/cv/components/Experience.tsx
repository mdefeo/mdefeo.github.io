      ...
      <section className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="space-y-6">
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-8">
              <div className="flex-1">
                <h4 className="text-xl font-bold text-gray-800">Interstate Aerials, LLC</h4>
                <p className="text-sm text-gray-500">Senior Application Engineer (LAMP Stack) | 08/2015 - 06/2017</p>
                <ul className="list-disc pl-5 text-gray-700">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-8">
              <div className="flex-1">
                <h4 className="text-xl font-bold text-gray-800">Brownstein Group</h4>
                <p className="text-sm text-gray-500">Senior Developer (LAMP Stack, C#, AWS) | 01/2012 - 02/2014</p>
                <ul className="list-disc pl-5 text-gray-700">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-8">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">Web Developer and Database Administrator (Java, LAMP Stack, Oracle) |
                  01/2005 - 01/2012</p>
                <ul className="list-disc pl-5 text-gray-700">
