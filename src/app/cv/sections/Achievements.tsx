      ...
      <section aria-labelledby="key-achievements-heading" className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">Leadership & Mentorship</h3>
          ...
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">System Scalability</h3>
            <p className="text-left text-md">
          ...
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">Secured GPS Tracking</h3>
            <p className="text-left text-md">
          ...
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">Data-Driven Solutions</h3>
            <p className="text-left text-md">
          ...
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">Problem Resolution</h3>
            <p className="text-left text-md">
          ...
          <div className="card bg-white p-6 shadow-lg rounded-xl">
            ...
            <h3 className="font-semibold text-md leading-5">Compliance Expertise</h3>
            <p className="text-left text-md">
