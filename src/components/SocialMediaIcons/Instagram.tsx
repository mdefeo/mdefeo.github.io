  ...
  return (
    ...
    >
      <defs>
        ...
        <radialGradient xlinkHref="#a" id="d" cx="27.5" cy="-41.5" r="148.5"></radialGradient>
        <radialGradient xlinkHref="#a" id="f" cx="13.87" cy="303.38" r="185.63"></radialGradient>
        <radialGradient xlinkHref="#a" id="j" cx="13.87" cy="-22.62" r="185.63"></radialGradient>
      </defs>
      <g clipPath="url(#b)">
      ...
      <rect width="64" height="64" x="32" y="32" fill="none" stroke="#fff" strokeMiterlimit="10" strokeWidth="8" rx="12" ry="12"></rect>
    </svg>
  );
};
