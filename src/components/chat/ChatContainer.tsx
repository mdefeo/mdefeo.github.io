...
const ChatContainer: React.FC = () => {
  ...
  return (
    <div className="chat-container h-[55vh] lg:mx-h-96 min-h-full w-full flex flex-col justify-between mx-auto mt-0 mb-8 shadow-sm hover:card hover:shadow-2xl transition-all duration-500 ease-in-out">
